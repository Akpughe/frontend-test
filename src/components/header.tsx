...
const Header = () => {
  return (
    <header className="w-full">
      <TopHeader />
      <nav className="max-w-6xl mx-auto py-6 px-4">
        <div className="flex flex-col md:flex-col lg:flex-row xl:flex-row justify-evenly items-center">
          <div>
            <h1 className="font-extrabold text-[#F45C5D] text-4xl tracking-wide italic">
              Car Store
            </h1>
          </div>
          <div className="max-w-2xl w-full flex items-center sm:space-x-16 space-x-7">
...
const TopHeader = () => {
  return (
    <div className="bg-[#0879c9] py-2 px-4 w-full flex flex-col md:flex-col lg:flex-row xl:flex-row items-center justify-between">
      <div className="">
        <p className="text-white">Offer Zone Top Deals & Discounts </p>
      </div>
      <div className="">
        <ul className="flex flex-wrap header_list w-full justify-center items-center space-x-10 pr-10">
          <li className="">
